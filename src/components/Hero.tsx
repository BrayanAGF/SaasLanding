...
export const Hero = () => {
  return (
    <div className="bg-black text-white bg-[linear-gradient(to_bottom,#000,#200D42_34%,#3F21A1_65%,#A46EDB_82%)] py-[72px] sm:py-24 relative overflow-clip md:h-[780px]">
      <div className='absolute h-[375px] w-[750px] sm:w-[1536px] sm:h-[768px] lg:w-[2400px] lg:h-[750px] rounded-[100%] bg-black left-1/2 -translate-x-1/2 border border-[#B48CDE] bg-[radial-gradient(closest-side,#000_92%,#9560EB)] top-[calc(100%-96px)] sm:top-[calc(100%-190px)]'></div>
      <div className="container relative">
        ...
        <div className='flex justify-center mt-8'>
          <div className='inline-flex relative'>
            ...
            <motion.div className='absolute right-[476px] top-[108px] hidden sm:inline cursor-grab'
              drag
              dragSnapToOrigin
            >
              <Image src={CursorImage} height="200" width="200" alt='cursor image' className='max-w-none' draggable={false} />
            </motion.div>
            <motion.div className='absolute left-[498px] top-[56px] hidden sm:inline cursor-grab'
              drag
              dragSnapToOrigin
            >
